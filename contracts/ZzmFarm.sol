...
contract ZzmFarm is ERC20Upgradeable {
...
//    using SafeERC20 for IERC20;
    ...
    constructor(address _erc20, uint256 _rewardPerBlock, uint256 _startBlock) public {
        erc20 = _erc20;
    ...
    function fund(uint256 _amount) public {
        ...
        TransferHelper.safeTransferFrom(erc20, msg.sender, address(this), _amount);
    ...
    function accumulated(uint256 _pid, address _user) external view returns (uint256) {
        UserInfo storage user = userInfo[_pid][_user];
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (user.amount > 0) {
            ...
            user.accumulatedReward = user.accumulatedReward.add(pendingAmount);
        }
    ...
    function erc20Transfer(address _to, uint256 _amount) internal {
        TransferHelper.safeTransfer(erc20, _to, _amount);
        paidOut += _amount;
    }
}